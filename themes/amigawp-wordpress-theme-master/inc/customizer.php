...
/**
 * Enqueue scripts and styles based on either the users preferences or the default settings.
 *
 * @since AmigaWP 1.0
 * @return void
 */
function amigawp_style_selection() {
	// Get from cookie
	$color_scheme = isset( $_COOKIE['color_scheme'] ) ? $_COOKIE['color_scheme'] : null;
