...
<div id="<?php echo esc_html( $action_type_id ); ?>" class="acm_card full-width">
	...
	<div class="acm_card__body">
		<div class="acm_rule_description">
			<p><?php echo Translation::rule_description( 'cidr' ); ?></p>
		</div>
		<div class="acm_new_rule cidr">
			<div class="single_input">
				<label for="cidr_expression">
					<p><?php echo Translation::rule_input_labels( 'cidr_expression' ); ?></p>
					<input type="text" name="cidr_expression" id="cidr_expression"
						value="<?php echo $rule->expression; ?>"
						placeholder="10.0.0.0/xx">
				</label>
