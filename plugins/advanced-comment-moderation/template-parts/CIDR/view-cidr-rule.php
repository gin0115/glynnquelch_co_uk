...
/**
 * The CIDR Template for the rule list
 *
 * @since 0.1.0
...
<div class="acm_rule__row">
	<div class="acm_rule__type">
		<h3><?php echo Translation::rule_name( 'cidr' ); ?></h3>
	...
	<div class="acm_rule__details">
		<p class="acm_rule__description">
			<?php
			printf(
				/* translators: %s The cidr expression */
				__( 'CIDR Expression <code>%s</code>', 'team51-advanced-comment-moderation' ),
				$expression
			);
			?>
				</p>
