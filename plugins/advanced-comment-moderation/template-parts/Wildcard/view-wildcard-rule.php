...
/**
 * The Wildcard Rule template for the rule list
 *
 * @since 0.1.0
...
<div class="acm_rule__row">
	<div class="acm_rule__type">
		<h3><?php echo Translation::rule_name( 'wildcard' ); ?></h3>
	...
	<div class="acm_rule__details">
		<p class="acm_rule__description">
			<?php
			printf(
				/* translators: %s The wildcard expression */
				__( 'Wildcard Expression <code>%s</code>', 'team51-advanced-comment-moderation' ),
				$expression
			);
			?>
				</p>
