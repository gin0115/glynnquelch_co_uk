...
<div id="<?php echo esc_html( $action_type_id ); ?>" class="acm_card full-width">
	...
	<div class="acm_card__body">
		<div class="acm_rule_description">
			<p><?php echo Translation::rule_description( 'regex' ); ?></p>
		</div>
		<div class="acm_new_rule regex">
			<div class="single_input">
				<label for="regex_expression">
					<p><?php echo Translation::rule_input_labels( 'regex_expression' ); ?></p>
					<input type="text" name="regex_expression" id="regex_expression"
